...
% incorporates noise masks, so noise bits are not used for calculating the HD
%
% Usage: 
% hd = gethd(template1, mask1, template2, mask2, scales)
%
% Arguments:
...
function hd = gethd(template1, mask1, template2, mask2, scales)
