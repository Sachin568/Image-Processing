% encode - generates a biometric template from the normalised iris region,also generates corresponding noise mask
%
% Usage: 
...
[E0, filtersum] = gaborconvolve(polar_array, nscales, minWaveLength, mult, sigmaOnf);         %display(E0);imshow(filtersum);     
